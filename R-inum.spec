...
Version  : 1.0.2
Release  : 31
URL      : https://cran.r-project.org/src/contrib/inum_1.0-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/inum_1.0-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612477871
