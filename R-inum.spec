...
Version  : 1.0.3
Release  : 32
URL      : https://cran.r-project.org/src/contrib/inum_1.0-3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/inum_1.0-3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612807290
